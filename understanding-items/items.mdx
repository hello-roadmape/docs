...
An item in Roadmape contains information about your projects. A feature or an epic are the most common examples of items.
...
- Use the keyboard shortcut `C` to open up an item creation pop-up.
...
<Info>The item type can be changed at the top left of the pop-up window.</Info>
